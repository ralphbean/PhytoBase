# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in PhytoBase.
...
base_config.model = phytobase.model
base_config.DBSession = phytobase.model.DBSession
